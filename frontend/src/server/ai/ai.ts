...
// 新的 API 配置
const AI_API_KEY = process.env.AI_API_KEY || 'sk-MMWb8B4jvJ0SPV68RhwKIE04xPcv3fzM5ZUCYONwaxBXcbtD';
const AI_API_ENDPOINT = process.env.AI_API_ENDPOINT || 'https://www.chatgtp.cn/v1/chat/completions';
...
export async function processDocument(
  ...
  console.log(`[AI] 使用模型: ${AI_MODEL}`);
  console.log(`[AI] API 端点: ${AI_API_ENDPOINT}`);
  ...
  console.log("[AI] 原始响应:", text.substring(0, 500));
